...
//print(tempforcast1);
  ...
  textAlign(RIGHT);
    ...
    fill(255)
    text(windSpeed,300, 500);
    text("Wind speed", 225, 500);
    fill(255,0,0);
    text(temp, 300,550);
    text("Temperature",225,550);
    fill(0,0,255);
    text(windDirection, 300,600);
    text("Wind Direction",225,600);
    // text(windangle, 30 windowHeight);

  //create ellipse and set width and height of the ellipse to windSpeed data
  fill(255);
  noStroke();
  rect(windowWidth / 2, windowHeight / 2, windSpeed * 10, windSpeed * 10);
  
   //create ellipse and set width and height of the ellipse to temp data
  noFill();
  strokeWeight(4);
  stroke(255,0,0);
  rect(windowWidth / 4, windowHeight / 2, temp * 2, temp * 2);
